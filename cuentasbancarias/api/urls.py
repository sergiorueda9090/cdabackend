...
from .views import (obtener_cuentas,       obtener_cuenta,      crear_cuenta, 
                    ...
                    download_report_excel, download_report_pdf, cuentasbancarias_filter_date)
...
urlpatterns = [
    ...
    path('api/cuenta/<int:id>/download_report_pdf/',                download_report_pdf,                name='download_report_pdf'),
]
